    ...
    return (
        <section className="py-16 md:py-28 px-8 md:px-16 bg-bg relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-start relative z-10">
                ...
                {/* Contact details and philosophy */}
                        ...
                        {[
                            ...
                            >
                                ...
                                <div className="flex flex-col space-y-2">
                                    <span className="text-[10px] font-bold uppercase text-accent font-manrope">{item.label}</span>
                ...
                <div className="relative mt-12 lg:mt-4 lg:ml-12 lg:w-[95%]">
                    <HeritageCardFrame
                        ...
                        <div className="p-8 md:p-16 lg:p-20 relative z-10 flex flex-col h-full bg-brand/5 border border-brand/20 rounded-[24px]">
                            ...
                            <form className="flex flex-col space-y-12 flex-grow">
                                <div className="flex flex-col space-y-4">
                                    <label className="text-[10px] font-bold uppercase text-accent">Full Name</label>
                                ...
                                <div className="flex flex-col space-y-4">
                                    <label className="text-[10px] font-bold uppercase text-accent">Electronic Address</label>
                                ...
                                <div className="flex flex-col space-y-4">
                                    <label className="text-[10px] font-bold uppercase text-accent">Correspondence</label>
